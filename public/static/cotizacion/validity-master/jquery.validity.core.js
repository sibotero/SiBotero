...
$.validity = {
    ...
    messages:{
        ...
        // Format validators:
        match:"#{field} tiene un formato no valido.",
        integer:"#{field} debe ser positivo",
        date:"#{field} la fecha debe ir en el formato (mm/dd/aaaa)",
        email:"#{field} debe ser un email valido.",
        usd:"#{field} debe ser una cantidad de dinero real",
        url:"#{field} debe tener formato de URL.",
        number:"#{field} debe ser un numero.",
        zip:"#{field} must be formatted as a zipcode ##### or #####-####.",
        phone:"#{field} debe estar formateado como telefono ###-###-####.",
        ...
        nonHtml:"#{field} no puede contener caracteres especiales.",
        alphabet:"#{field} debe contener solo letras del alfabeto.",

        minCharClass:"#{field} cannot have more than #{min} #{charClass} characters.",
        maxCharClass:"#{field} cannot have less than #{min} #{charClass} characters.",
        
        // Aggregate validator messages:
        equal:"Los valores son diferentes.",
