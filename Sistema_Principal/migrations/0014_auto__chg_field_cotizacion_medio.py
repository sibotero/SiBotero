...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cotizacion.medio'
        db.alter_column(u'Sistema_Principal_cotizacion', 'medio_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Sistema_Principal.Medio_Publicitario']))
