...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Inventario_motos', fields ['moto']
        db.create_unique(u'Sistema_Principal_inventario_motos', ['moto_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Inventario_motos', fields ['moto']
        db.delete_unique(u'Sistema_Principal_inventario_motos', ['moto_id'])
