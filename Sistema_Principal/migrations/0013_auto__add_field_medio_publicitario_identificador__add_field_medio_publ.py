...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'medio_publicitario.identificador'
        db.add_column(u'Sistema_Principal_medio_publicitario', 'identificador',
                      self.gf('django.db.models.fields.IntegerField')(default=None, max_length=3),
                      keep_default=False)

        # Adding field 'medio_publicitario.empresa'
        db.add_column(u'Sistema_Principal_medio_publicitario', 'empresa',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['Sistema_Principal.Empresa']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'medio_publicitario.identificador'
        db.delete_column(u'Sistema_Principal_medio_publicitario', 'identificador')

        # Deleting field 'medio_publicitario.empresa'
        db.delete_column(u'Sistema_Principal_medio_publicitario', 'empresa_id')
