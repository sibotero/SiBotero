...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cotizacion.no_aplicables'
        db.add_column(u'Sistema_Principal_cotizacion', 'no_aplicables',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cotizacion.no_aplicables'
        db.delete_column(u'Sistema_Principal_cotizacion', 'no_aplicables')
