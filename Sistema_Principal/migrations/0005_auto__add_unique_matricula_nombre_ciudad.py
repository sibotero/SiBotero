...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Matricula', fields ['nombre_ciudad']
        db.create_unique(u'Sistema_Principal_matricula', ['nombre_ciudad'])


    def backwards(self, orm):
        # Removing unique constraint on 'Matricula', fields ['nombre_ciudad']
        db.delete_unique(u'Sistema_Principal_matricula', ['nombre_ciudad'])
