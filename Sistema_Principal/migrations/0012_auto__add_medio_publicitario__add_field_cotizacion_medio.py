...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'Sistema_Principal_medio_publicitario', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('medio', self.gf('django.db.models.fields.CharField')(max_length='30')),
        ))
        db.send_create_signal(u'Sistema_Principal', ['medio_publicitario'])

        # Adding field 'Cotizacion.medio'
        db.add_column(u'Sistema_Principal_cotizacion', 'medio',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['Sistema_Principal.medio_publicitario']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'medio_publicitario'
        db.delete_table(u'Sistema_Principal_medio_publicitario')

        # Deleting field 'Cotizacion.medio'
        db.delete_column(u'Sistema_Principal_cotizacion', 'medio_id')
