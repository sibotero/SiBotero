...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cliente.es_vip'
        db.add_column(u'Sistema_Principal_cliente', 'es_vip',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cliente.es_vip'
        db.delete_column(u'Sistema_Principal_cliente', 'es_vip')
