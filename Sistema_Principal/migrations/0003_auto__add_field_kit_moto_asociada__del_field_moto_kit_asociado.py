...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Kit.moto_asociada'
        db.add_column(u'Sistema_Principal_kit', 'moto_asociada',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['Sistema_Principal.Moto']),
                      keep_default=False)

        # Deleting field 'Moto.kit_asociado'
        db.delete_column(u'Sistema_Principal_moto', 'kit_asociado_id')


    def backwards(self, orm):
        # Deleting field 'Kit.moto_asociada'
        db.delete_column(u'Sistema_Principal_kit', 'moto_asociada_id')

        # Adding field 'Moto.kit_asociado'
        db.add_column(u'Sistema_Principal_moto', 'kit_asociado',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['Sistema_Principal.Kit']),
                      keep_default=False)
