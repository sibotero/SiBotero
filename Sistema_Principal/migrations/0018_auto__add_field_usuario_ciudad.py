...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Usuario.ciudad'
        db.add_column(u'Sistema_Principal_usuario', 'ciudad',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=24),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Usuario.ciudad'
        db.delete_column(u'Sistema_Principal_usuario', 'ciudad')
