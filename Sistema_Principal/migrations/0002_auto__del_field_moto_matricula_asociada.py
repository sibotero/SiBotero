...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Moto.matricula_asociada'
        db.delete_column(u'Sistema_Principal_moto', 'matricula_asociada_id')
    ...
    def backwards(self, orm):
        # Adding field 'Moto.matricula_asociada'
        db.add_column(u'Sistema_Principal_moto', 'matricula_asociada',
