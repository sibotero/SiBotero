...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'T_financiacion', fields ['num_meses']
        db.create_unique(u'Sistema_Principal_t_financiacion', ['num_meses'])


    def backwards(self, orm):
        # Removing unique constraint on 'T_financiacion', fields ['num_meses']
        db.delete_unique(u'Sistema_Principal_t_financiacion', ['num_meses'])
