...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Usuario.es_superadmin'
        db.delete_column(u'Sistema_Principal_usuario', 'es_superadmin')


    def backwards(self, orm):
        # Adding field 'Usuario.es_superadmin'
        db.add_column(u'Sistema_Principal_usuario', 'es_superadmin',
