...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cliente.cedula'
        db.alter_column(u'Sistema_Principal_cliente', 'cedula', self.gf('django.db.models.fields.CharField')(unique=True, max_length=20))

    def backwards(self, orm):

        # Changing field 'Cliente.cedula'
        db.alter_column(u'Sistema_Principal_cliente', 'cedula', self.gf('django.db.models.fields.CharField')(max_length=10, unique=True))
