...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Matricula', fields ['empresa', 'nombre_ciudad']
        db.create_unique(u'Sistema_Principal_matricula', ['empresa_id', 'nombre_ciudad'])

        # Adding field 'Cotizacion.matricula_asociada'
        db.add_column(u'Sistema_Principal_cotizacion', 'matricula_asociada',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['Sistema_Principal.Matricula']),
                      keep_default=False)

        # Removing M2M table for field matricula_asociada on 'Cotizacion'
        db.delete_table('Sistema_Principal_cotizacion_matricula_asociada')


    def backwards(self, orm):
        # Removing unique constraint on 'Matricula', fields ['empresa', 'nombre_ciudad']
        db.delete_unique(u'Sistema_Principal_matricula', ['empresa_id', 'nombre_ciudad'])

        # Deleting field 'Cotizacion.matricula_asociada'
        db.delete_column(u'Sistema_Principal_cotizacion', 'matricula_asociada_id')

        # Adding M2M table for field matricula_asociada on 'Cotizacion'
        db.create_table(u'Sistema_Principal_cotizacion_matricula_asociada', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('cotizacion', models.ForeignKey(orm[u'Sistema_Principal.cotizacion'], null=False)),
            ('matricula', models.ForeignKey(orm[u'Sistema_Principal.matricula'], null=False))
        ))
        db.create_unique(u'Sistema_Principal_cotizacion_matricula_asociada', ['cotizacion_id', 'matricula_id'])
