...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Moto', fields ['referencia', 'modelo', 'empresa']
        db.create_unique(u'Sistema_Principal_moto', ['referencia', 'modelo', 'empresa_id'])

        # Adding unique constraint on 'T_financiacion', fields ['num_meses', 'empresa']
        db.create_unique(u'Sistema_Principal_t_financiacion', ['num_meses', 'empresa_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'T_financiacion', fields ['num_meses', 'empresa']
        db.delete_unique(u'Sistema_Principal_t_financiacion', ['num_meses', 'empresa_id'])

        # Removing unique constraint on 'Moto', fields ['referencia', 'modelo', 'empresa']
        db.delete_unique(u'Sistema_Principal_moto', ['referencia', 'modelo', 'empresa_id'])
