...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cotizacion.n_no_aplicables'
        db.add_column(u'Sistema_Principal_cotizacion', 'n_no_aplicables',
                      self.gf('django.db.models.fields.IntegerField')(default=None, max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cotizacion.n_no_aplicables'
        db.delete_column(u'Sistema_Principal_cotizacion', 'n_no_aplicables')
