...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Moto', fields ['referencia']
        db.delete_unique(u'Sistema_Principal_moto', ['referencia'])


    def backwards(self, orm):
        # Adding unique constraint on 'Moto', fields ['referencia']
        db.create_unique(u'Sistema_Principal_moto', ['referencia'])
